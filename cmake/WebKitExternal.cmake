...
execute_process(
  COMMAND ${CMAKE_COMMAND} "-DWEBKIT_ROOT=${WEBKIT_ROOT}" "-DWEBKIT_BUILD_DIR=${WEBKIT_BUILD_DIR}" "-DEXCLUDE=(Layout|JS)Tests|\\.svn" -P "${CMAKE_SOURCE_DIR}/cmake/WebKitFixup.cmake"
)
...
set(ENABLE_DFG_JIT ON CACHE BOOL "" FORCE)
set(ENABLE_FTL_JIT ON CACHE BOOL "" FORCE)
set(ENABLE_WEBCORE OFF CACHE BOOL "" FORCE)
set(ENABLE_WEBKIT ON CACHE BOOL "" FORCE)
set(ENABLE_WEBASSEMBLY ON CACHE BOOL "" FORCE)
set(ENABLE_STATIC_JSC ON CACHE BOOL "" FORCE)
set(ENABLE_EXPERIMENTAL_FEATURES ON CACHE BOOL "" FORCE)
set(ENABLE_FETCH_API ON CACHE BOOL "" FORCE)

set(ENABLE_TOOLS ON CACHE BOOL "" FORCE)
set(ENABLE_C_LOOP OFF CACHE BOOL "" FORCE)
